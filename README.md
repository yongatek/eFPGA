...
WI3.4.5-1 and WI3.4.5-1.1 are waived to allow the FPGA to be programmable to variable frequencies.
WI3.4.5-2, WI3.4.5-2.1, and WI3.4.5-2.2 are waived to improve functionality by supporting multiple reset domains.
WI3.4.5-5.1 is waived to area constraints.
WI3.4.5-6 is waived due to hardware and tool limitations.
WI3.4.5-7-2 is waived for system compatibility.